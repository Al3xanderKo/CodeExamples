...
public class TriedenieZlucenim {
	...
	public static void triedenieZlucenim(String[] a, int from, int to) {
		if (from == to) {
			return;
		}
		int mid = (from + to) / 2;
		// sort the first and the second half
		triedenieZlucenim(a, from, mid);
		triedenieZlucenim(a, mid + 1, to);
		Zluc(a, from, mid, to);
	}// end mergeSort
//work

	public static void Zluc(String[] a, int from, int mid, int to) {
